    ...
    >
      <header className="flex items-center justify-between px-8 py-10 border-b border-outline-variant/30">
        ...
        <button
          ...
          className="p-2 transition-colors rounded-full hover:bg-surface-container-high"
        >
      ...
      <div className="flex-1 px-8 py-8 space-y-10 overflow-y-auto hide-scrollbar">
        {/* Category */}
        <div>
          <h3 className="mb-4 tracking-widest uppercase font-label-caps text-primary">
            Category
          </h3>
          ...
          <div className="flex flex-wrap gap-3">
            {sizes.map((size) => (
              <button
                ...
                className={`w-12 h-12 flex items-center justify-center border font-label-caps transition-all ${
                  selectedSize === size
      ...
      <footer className="flex gap-4 p-8 border-t bg-surface border-outline-variant/30">
        <button
          ...
          className="flex-1 py-4 tracking-widest uppercase transition-all border border-outline font-label-caps text-label-caps text-primary hover:bg-surface-container"
        >
          Clear All
        </button>
        <button
          onClick={() => setIsFilterOpen(false)}
          className="flex-1 py-4 tracking-widest uppercase transition-all bg-primary text-on-primary font-label-caps text-label-caps hover:bg-secondary"
        >
          Apply
        </button>
      </footer>
